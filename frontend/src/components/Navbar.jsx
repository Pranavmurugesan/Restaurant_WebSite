    ...
    >
      <div className="container mx-auto px-4 lg:px-12 flex items-center justify-between">
        <div className="flex-1 flex justify-start">
          <a href="#" className={`font-serif text-lg lg:text-2xl font-bold tracking-widest whitespace-nowrap ${scrolled ? 'text-charcoal' : 'text-white'}`}>
            THE LATTICE BISTRO
          </a>
        </div>

        <div className={`hidden lg:flex justify-center space-x-4 xl:space-x-8 text-xs lg:text-sm font-medium tracking-wide ${scrolled ? 'text-charcoal' : 'text-white'}`}>
